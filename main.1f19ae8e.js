...
var glideIntro = document.querySelector('.glide--intro');

if (glideIntro) {
  new _glide.default('.glide--intro', {
    type: 'carousel',
    autoplay: 2000,
    bound: true,
    startAt: 0,
...
var glideFeedback = document.querySelector('.glide--feedback');

if (glideFeedback) {
  new _glide.default('.glide--feedback', {
    type: 'carousel',
    autoplay: 3000,
    bound: true,
    startAt: 0,
...
var header = document.querySelector('.header--homepage');
...
if (menuBtn) {
  ...
  menuBtn.addEventListener('click', function (e) {
    ...
    if (menuOpen) {
      ...
      _header.classList.remove('header--open');
      ...
      _header.classList.add('header--open');
...
var filterWrapper = document.querySelectorAll('.filter');

if (filterWrapper && filterWrapper.length > 0) {
  filterWrapper.forEach(function (filter) {
    var filterListItems = filter.querySelectorAll('.filter__item');
    filterListItems.forEach(function (filterItem) {
      filterItem.addEventListener('click', function (e) {
        e.preventDefault();
        var showAllFilter = e.target.hasAttribute('data-category-all');
        var showCategoryFilter = e.target.hasAttribute('data-category');
        var productsList = filter.querySelectorAll('.filter__product');
        toggleFilterClasses(filterListItems, e);

        if (showAllFilter) {
          showAllProducts(productsList);
        } else if (showCategoryFilter) {
          var filterValue = e.target.getAttribute('data-category');
          showFilteredProducts(productsList, filterValue);
        }
      });
    });

    var toggleFilterClasses = function toggleFilterClasses(list, e) {
    ...
    var showAllProducts = function showAllProducts(list) {
      list.forEach(function (item) {
        item.classList.remove('filter__product--hidden');
      });
    };

    var showFilteredProducts = function showFilteredProducts(list, category) {
      list.forEach(function (item) {
        item.getAttribute('data-belongs-to') === category ? item.classList.remove('filter__product--hidden') : item.classList.add('filter__product--hidden');
      });
    };
  });
} // // comparison
